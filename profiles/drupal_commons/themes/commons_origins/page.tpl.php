    ...
    <div id="page-inner" class="page-inner">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
		  ...
		  <div id="show-ut"><?php  print l(t("一起去开源星际旅行"),"home");?></div>
            <?php print $pre_header_menu; ?>
            <?php print $header; ?>
      ...
      <div class="breadcrumbs-wrapper">
        <div class="breadcrumbs-content row <?php print $grid_width; ?>">
            <div id="breadcrumbs-sign">您当前的位置：</div><?php print $pre_breadcrumb; ?>
        </div>
      </div>
                            ...
                            <?php if ($title && !$is_front): ?>
                                ...
                                <?php if  (!empty($group_header_image)): ?>
                                  <div id="group-header" class="group-header">
                                    ...
                                    <li><span> <?php print t("Group Description:");?></span>
				     <?php print $group_header_text;?></li>
				    <li><span>
				      <?php print t("Group Type:");?></span>                                     <?php print $group_header_type;?>
				    </li>
                                    <li><span>
                                      <?php print t("Group Url:");?></span>
	                   <a href="<?php print $group_header_url;?>"><?php print $group_header_url;?></a>
                                    </li>
                                    <li><span>
                                      <?php print t("Group Place:");?></span>                                     <?php print $group_header_location;?>
                                    </li>
                                    <li><span>
                                      <?php print t("Posts Num:");?></span>                                     <?php print $group_header_posts;?>
                                    </li>
                                    <li><span>
                                      <?php print t("Members Num:");?></span>                                     <?php print $group_header_members;?>
                                    </li>
...
<div id="main-content-bottom"></div>
	...
	<div id="footer-bottom">
	   <div class="footer-bottom">
		<div id="footer-copy"><span>© 开源公共社群(Openunion)</span></div>
		<div id="footer-num"><span>京ICP备08124133号</span></div>
          </div>
	</div>
